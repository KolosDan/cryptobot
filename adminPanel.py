...
def admin(_id):
    ...
    btn4= types.InlineKeyboardButton(text="Далее ⏩")
...
def admin2(_id):
    ...
    btn4 =types.InlineKeyboardButton(text="◀️Назад")
    btn5 =types.InlineKeyboardButton(text="Далее▶️")
    keys.row(btn,btn1)
    keys.row(btn2,btn3)
    keys.row(btn4,btn5)
    return keys
...
def admin3(_id):
    keys = types.ReplyKeyboardMarkup()
    btn= types.InlineKeyboardButton(text="еще кнопка")
    btn1= types.InlineKeyboardButton(text="Контент База знаний")
    btn2 =types.InlineKeyboardButton(text="Контент Майнинг")
    btn3 =types.InlineKeyboardButton(text="Вопросы клиентов")
    btn4 =types.InlineKeyboardButton(text="⏪Назад")
    btn5 =types.InlineKeyboardButton(text="🔙 Главное меню")
    keys.row(btn,btn1)
    keys.row(btn2,btn3)
    keys.row(btn4,btn5)
